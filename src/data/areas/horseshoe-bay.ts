...
export const horseshoeBay: Area = {
  slug: "horseshoe-bay",
  city: "Horseshoe Bay",
  ...
  heroPhoto: "/stock/5.jpg",
  bodyPhoto: "/stock/18.jpg",
  lat: 30.536,
  lng: -98.3781,
  zip: "78657",
  nearby: ["marble-falls", "kingsland", "cottonwood-shores"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Horseshoe Bay, Texas",
      title: "Planning built for the resort community on Lake LBJ.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/18.jpg",
      alt: "Modern lakeside architecture",
      caption:
    ...
    },
    {
      ...
      title: "The Horseshoe Bay demographic.",
      subtitle:
    ...
    {
      kind: "alternating",
      eyebrow: "Dual residency and cross-county titling",
      title: "Two homes, two counties, one plan that handles both.",
      body: [
      ...
      image: "/stock/14.jpg",
      imageAlt: "Document keys and a wallet on a wooden surface",
      imageSide: "left",
      bullets: [
        {
          title: "Primary residence deeded into trust",
          body: "Whether in Texas or another state.",
        },
        {
          title: "Horseshoe Bay home deeded into trust",
          body: "Filed in Llano or Burnet County as applicable.",
        },
        {
          title: "Resort-club membership handled",
          body: "Many memberships are transferrable through the trust with the resort's cooperation.",
        },
        {
          title: "Boats, golf carts, recreational vehicles",
          body: "Titled or assigned in a way that survives probate.",
        },
      ],
    },
    {
      kind: "mapEmbed",
      query: "Horseshoe Bay, TX",
      lat: 30.536,
      lng: -98.3781,
      zoom: 13,
      address: "Horseshoe Bay, Texas 78657 — Llano & Burnet Counties",
      caption:
    ...
    {
      kind: "deep",
      eyebrow: "Lake LBJ specifics",
      title: "What planning around a constant-level lake actually involves.",
      body: [
    ...
    {
      kind: "cardGrid",
      eyebrow: "Services available to Horseshoe Bay clients",
      title: "What we build for the resort community.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Coordinated multi-state plans with primary and secondary home titling.",
        },
        {
          icon: "vault",
          title: "Living Trusts",
          body: "Revocable trusts that hold both residences and avoid dual-state probate.",
        },
        {
          icon: "lock",
          title: "Irrevocable Trusts",
          body: "ILITs and SLATs for high-net-worth families approaching federal exemption.",
        },
        {
          icon: "shield",
          title: "Asset Protection",
          body: "Layered defense — important for business owners and high-liability professionals.",
        },
        {
          icon: "briefcase",
          title: "Business Trusts",
          body: "Trust-owned LLC structures for resort-area business owners.",
        },
        {
          icon: "succession",
          title: "Business Succession",
          body: "Exit planning for HB business owners moving toward retirement.",
        },
      ],
    },
    {
      kind: "faq",
      eyebrow: "Horseshoe Bay FAQ",
      title: "Questions HB families ask.",
      items: [
        {
          q: "Our primary residence is out of state — can a Texas trust still hold it?",
          a: "Yes. A Texas-formed trust can hold real property in any state. We deed the out-of-state property into the trust using that state's deed format and recording requirements. Most Horseshoe Bay clients who own a primary home in another state end up with a single Texas trust holding both properties, which is cleaner and cheaper than maintaining separate plans.",
        },
        {
          q: "Does putting the lake home in a trust affect Lake LBJ riparian rights?",
          a: "No. Riparian rights attach to the property, not to the owner's name. Transferring the property into a trust transfers the rights with it. The same applies to boat-slip licenses, dock permits, and shoreline easements — all follow the property into the trust.",
        },
        {
          q: "How do you handle the resort and golf club memberships?",
          a: "Most Horseshoe Bay Resort club memberships have specific transferability rules in their member agreements. We coordinate with the resort to confirm that the trust is recognized as the holder and that membership rights survive the transfer. Equity memberships sometimes require additional steps, which we handle directly with the resort's membership office.",
        },
        {
          q: "What about my Travis County or Burnet County tax assessment?",
          a: "Trust ownership does not trigger a reappraisal under Texas Tax Code §11.13(j) when the transfer is to a qualifying revocable trust of which the original owner is a trustor and beneficiary. Your assessed value, homestead exemption (if claimed), and over-65 freeze (if applicable) all carry over unchanged.",
        },
      ],
    },
  ],
