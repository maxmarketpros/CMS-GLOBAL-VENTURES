...
export const marbleFalls: Area = {
  ...
  localHook:
    "Burnet County's probate court is a short drive from Marble Falls. We help families avoid that courthouse altogether through proper trust planning.",
  ...
  heroPhoto: "/stock/13.jpg",
  bodyPhoto: "/stock/19.jpg",
  lat: 30.5783,
  lng: -98.2728,
  zip: "78654",
  nearby: ["cottonwood-shores", "horseshoe-bay", "burnet"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Marble Falls, Texas",
      title: "Built for the Highland Lakes families we have served since 2009.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/19.jpg",
      alt: "Texas Hill Country lake at sunset",
      caption: "Lake Marble Falls — the heart of the Highland Lakes chain.",
      aspect: "wide",
    },
    {
      kind: "deep",
      eyebrow: "Where Marble Falls came from",
      title: "From granite town to lake-centered economy.",
      body: [
    ...
    {
      kind: "mapEmbed",
      query: "Marble Falls, TX",
      lat: 30.5783,
      lng: -98.2728,
      zoom: 13,
      address: "Marble Falls, Burnet County, Texas 78654",
      caption:
    ...
    {
      kind: "alternating",
      eyebrow: "What Marble Falls clients usually ask first",
      title: "The three conversations we have most often.",
      body: [
      ...
      image: "/stock/2.jpg",
      imageAlt: "Family reviewing estate planning documents in Marble Falls",
      imageSide: "right",
      bullets: [
        {
          title: "Keep the kids out of probate",
          body: "Funded living trust is the most reliable answer.",
        },
        {
          title: "Protect the business and the family separately",
          body: "Layered LLCs, trust ownership, insurance coordination.",
        },
        {
          title: "Plan for long-term care years in advance",
          body: "Five-year Medicaid look-back means this is not a same-day decision.",
        },
        {
          title: "Coordinate with out-of-state heirs",
          body: "Lake homes, vacation property, and traveling kids all factor in.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "Services available to Marble Falls residents",
      title: "Everything we build, available locally.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Full coordinated plans with trust, will, POAs, and directives.",
        },
        {
          icon: "vault",
          title: "Living Trusts",
          body: "Revocable trusts that skip Burnet County probate.",
        },
        {
          icon: "lock",
          title: "Irrevocable Trusts",
          body: "Maximum protection for legacy and Medicaid planning.",
        },
        {
          icon: "briefcase",
          title: "Business Trusts",
          body: "Trust-owned LLC structures for Marble Falls business owners.",
        },
        {
          icon: "shield",
          title: "Asset Protection",
          body: "Layered defense against lawsuits and creditors.",
        },
        {
          icon: "feather",
          title: "Wills",
    ...
    {
      kind: "faq",
      eyebrow: "Marble Falls FAQ",
      title: "What Marble Falls families ask before we meet.",
      items: [
        {
          q: "Do you have an office in Marble Falls?",
          a: "We meet clients in person throughout the Highland Lakes — at our Granite Shoals service area, at your home, at your business, or at a quiet meeting room in Marble Falls when that works best. The first consultation is free and typically runs sixty to ninety minutes. We have served Marble Falls families for more than fifteen years and the drive is short.",
        },
        {
          q: "Which county handles probate for Marble Falls residents?",
        ...
        {
          q: "How does my Marble Falls lake home fit into a trust?",
          a: "The home is deeded into your trust via a recorded warranty deed filed with the Burnet County Clerk. We prepare the deed, walk through the homestead-exemption preservation language, and file it on your behalf. Your lender and your homeowner's insurance carrier are notified, both of which are routine. The transfer does not trigger a tax event or affect your property-tax assessment.",
        },
        {
          q: "What if I split time between Marble Falls and another state?",
          a: "Your trust travels with you across state lines — a Texas trust is generally recognized in every state. Your POAs and healthcare directives may need to be reissued on the destination state's statutory forms because hospitals and banks prefer in-state documents. If you spend significant time elsewhere, we can prepare matching documents for both states during the same engagement.",
        },
      ],
    },
  ],
