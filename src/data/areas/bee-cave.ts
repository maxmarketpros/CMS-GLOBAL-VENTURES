...
export const beeCave: Area = {
  ...
  heroPhoto: "/stock/10.jpg",
  bodyPhoto: "/stock/15.jpg",
  lat: 30.3083,
  lng: -97.9486,
  zip: "78738",
  nearby: ["lakeway", "spicewood", "lago-vista"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Bee Cave, Texas",
      title: "Austin-adjacent growth. Future-proofed plans.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/15.jpg",
      alt: "Modern Austin-area suburban home",
      caption:
        "Bee Cave — Austin's western growth corridor, where tech and professional wealth lives.",
      aspect: "wide",
    },
    {
      kind: "deep",
      eyebrow: "Younger wealth, longer time horizons",
      title: "Why Bee Cave plans look forward, not backward.",
      body: [
    ...
    },
    {
      ...
      lng: -97.9486,
      zoom: 13,
      address: "Bee Cave, Travis County, Texas 78738",
      caption:
    ...
    {
      kind: "alternating",
      eyebrow: "Trust-owned LLCs for younger entrepreneurs",
      title: "The structure that scales with you.",
      body: [
      ...
      image: "/stock/3.jpg",
      imageAlt: "A team meeting in a modern Austin-area office",
      imageSide: "left",
      bullets: [
        {
          title: "Trust at the top of the stack",
          body: "Holds ownership of every entity through a single document.",
        },
        {
          title: "LLCs at the operating level",
          body: "Each business in its own entity for liability isolation.",
        },
        {
          title: "Funding repeats with each new venture",
          body: "New entities assigned to the trust as they form.",
        },
        {
          title: "Buy-sell coordination across partners",
          body: "Trust ownership integrated with partner agreements.",
        },
      ],
    },
    {
      kind: "stats",
      eyebrow: "Bee Cave by the numbers",
      title: "Why the planning here is different.",
      subtitle:
      ...
      items: [
        {
          value: "+1,650%",
          label: "Population growth since 2000",
          sublabel:
            "From 526 residents in 2000 to over 9,100 today — the fastest growth in our service area.",
        },
        {
          value: "$111K",
          label: "Median household income",
          sublabel:
            "Among the highest in central Texas, driven by Austin tech wealth.",
        },
        {
          value: "41.7",
          label: "Median age",
          sublabel:
            "Younger than the Highland Lakes average — many households still raising children.",
        },
        {
          value: "58%",
          label: "Families with children",
          sublabel:
            "Family-heavy demographic with guardianship planning as a core concern.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "Services for Bee Cave clients",
      title: "What forward-looking plans need.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Forward-looking plans designed for growing families and businesses.",
        },
        {
          icon: "vault",
          title: "Living Trusts",
          body: "Foundation document with strong guardianship provisions.",
        },
        {
          icon: "briefcase",
          title: "Business Trusts",
          body: "Trust-owned LLCs for tech founders and professional practices.",
        },
        {
          icon: "shield",
          title: "Asset Protection",
          body: "Layered defense for professionals with growing liability exposure.",
        },
        {
          icon: "succession",
          title: "Business Succession",
          body: "Exit planning for founders building toward a liquidity event.",
        },
        {
          icon: "feather",
          title: "Wills",
          body: "Pour-over wills with named guardians for minor children.",
        },
      ],
    },
    {
      kind: "faq",
      eyebrow: "Bee Cave FAQ",
      title: "Questions from younger Bee Cave families.",
      items: [
        {
          q: "We are in our late thirties — do we really need an estate plan now?",
        ...
        {
          q: "I have equity that has not vested yet — can the trust handle that?",
          a: "Yes. Unvested equity can be assigned to the trust contingent on vesting, or held outside the trust until vesting with a clear plan for when to move it in. We coordinate with your equity grant documents and your company's transfer rules to confirm what the trust can hold directly and what has to wait. For RSUs, ISOs, and most LLC profits interests, the plan accommodates the vesting schedule rather than fighting it.",
        },
        {
          q: "What about cryptocurrency and digital assets?",
          a: "We include digital-asset provisions in every Bee Cave plan because the question comes up often. The trust can own cryptocurrency through proper key management protocols, and we provide a written digital-asset memorandum that documents how to access wallets and accounts when the time comes. The trust language references digital assets explicitly to satisfy Texas Estates Code Chapter 2001 (Texas's adopted version of the Revised Uniform Fiduciary Access to Digital Assets Act).",
        },
        {
          q: "If we move out of Austin to a different city, will the plan still work?",
