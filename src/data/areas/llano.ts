...
export const llano: Area = {
  ...
  localHook:
    "Llano County's probate docket runs through the historic 1893 courthouse on the square. We build plans designed to keep your family off it.",
  ...
  heroPhoto: "/stock/20.jpg",
  bodyPhoto: "/stock/21.jpg",
  lat: 30.7591,
  lng: -98.6759,
  zip: "78643",
  nearby: ["kingsland", "horseshoe-bay", "burnet"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Llano, Texas",
      title: "County seat, ranching heritage, and multi-generational land.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/21.jpg",
      alt: "Texas Hill Country ranch land at sunset",
      caption:
    ...
    {
      kind: "deep",
      eyebrow: "The 1893 courthouse on the square",
      title: "Why we plan to keep your family out of the building.",
      body: [
    ...
    },
    {
      ...
      lng: -98.6759,
      zoom: 13,
      address: "Llano County Courthouse Square, Llano, TX 78643",
      caption:
    ...
    {
      kind: "alternating",
      eyebrow: "Ranch land and mineral rights",
      title: "What multi-generational land planning actually looks like.",
      body: [
      ...
      image: "/stock/13.jpg",
      imageAlt: "Wide Texas ranch land with cattle",
      imageSide: "left",
      bullets: [
        {
          title: "Multi-generational trust holds the land",
          body: "Up to 300 years under Texas Property Code §112.036.",
        },
        {
          title: "Trust-owned LLC for the operating side",
          body: "Contains hunting-lease liability, cattle operations, equipment.",
        },
        {
          title: "Mineral rights deeded together or separately",
          body: "Depending on whether surface and minerals are still combined.",
        },
        {
          title: "Equitable structure for non-ranching heirs",
          body: "Non-land assets, life-insurance funding, or a structured buyout.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "Available to Llano County families",
      title: "The services that fit Llano planning best.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Multi-generational plans built for ranching families.",
        },
        {
          icon: "vault",
          title: "Living Trusts",
          body: "The foundation document — avoids Llano County probate.",
        },
        {
          icon: "briefcase",
          title: "Business Trusts",
          body: "Trust-owned LLCs for ranch operations and hunting leases.",
        },
        {
          icon: "lock",
          title: "Irrevocable Trusts",
          body: "Dynasty trusts that hold family land across generations.",
        },
        {
          icon: "succession",
          title: "Business Succession",
          body: "Transitioning operating responsibility to the next-generation rancher.",
        },
        {
          icon: "balance",
          title: "Probate Assistance",
          body: "If a Llano County estate has already opened, we help the family through it.",
        },
      ],
    },
    {
      kind: "faq",
      eyebrow: "Llano County FAQ",
      title: "What ranch families ask first.",
      items: [
        {
          q: "Does putting our ranch in a trust trigger a property-tax reappraisal?",
          a: "Transferring real property to a qualifying revocable trust is not a change of ownership for ad valorem tax purposes under Texas Tax Code §11.13(j). The Llano County Appraisal District treats the trust as the owner going forward, but the assessed value, homestead exemption (if claimed), and over-65 freeze (if applicable) all carry over without change.",
        },
        {
          q: "What happens to ag-valuation when the land is in a trust?",
        ...
        {
          q: "How do we handle mineral rights that have been split off from the surface?",
          a: "Mineral interests are deeded into the trust the same way surface real estate is — by recorded deed with the county clerk. We prepare the mineral deed, file it, and then notify the operator of the well (if any) so future royalty checks are made out to the trust. If the mineral interest is non-producing, the deed transfer still goes on record so it follows the rest of the estate when the time comes.",
        },
        {
          q: "Will my Llano County hunting lease still work if the land is in a trust?",
          a: "Yes. Hunting leases are contracts between the landowner and the lessees. When the trust becomes the owner, the trustee (often you, while you are alive and well) signs new leases on the trust's behalf. Existing leases stay in effect until their renewal date and roll over naturally with the next lease cycle.",
        },
      ],
    },
  ],
