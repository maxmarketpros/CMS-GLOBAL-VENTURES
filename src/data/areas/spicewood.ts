...
export const spicewood: Area = {
  ...
  heroPhoto: "/stock/16.jpg",
  bodyPhoto: "/stock/17.jpg",
  lat: 30.4707,
  lng: -98.1392,
  zip: "78669",
  nearby: ["lakeway", "marble-falls", "bee-cave"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Spicewood, Texas",
      title: "Where the Hill Country meets Austin — and where the planning gets interesting.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/17.jpg",
      alt: "Lake Travis lakefront home in Spicewood",
      caption:
        "Spicewood — where Hill Country ranches meet Lake Travis lakefront and Austin tech wealth.",
      aspect: "wide",
    },
    {
      kind: "stats",
      eyebrow: "Who Spicewood actually is",
      title: "The demographic that drives our planning here.",
      subtitle:
      ...
      items: [
        ...
        {
          value: "88%",
          label: "Professional / admin roles",
          sublabel:
            "Heavily concentrated in higher-income white-collar work.",
        },
        {
          value: "21%",
          label: "Age 65+",
          sublabel: "Substantial retiree base alongside younger professionals.",
        },
        {
          value: "3",
          label: "Counties spanned",
          sublabel:
            "Burnet, Travis, and Blanco counties all overlap Spicewood's 78669 ZIP.",
        },
      ],
    },
    {
      kind: "deep",
      eyebrow: "Cross-county titling",
      title: "Why where the property sits matters as much as what it is.",
      body: [
    ...
    },
    {
      ...
      lng: -98.1392,
      zoom: 12,
      address: "Spicewood, Texas 78669 — Burnet, Travis & Blanco Counties",
      caption:
    ...
    {
      kind: "alternating",
      eyebrow: "The professional / family-land mix",
      title: "Two client profiles, often the same plan.",
      body: [
      ...
      image: "/stock/6.jpg",
      imageAlt: "A business team in conference about estate planning",
      imageSide: "right",
      bullets: [
        {
          title: "High-income professionals",
          body: "Layered asset protection, irrevocable structures, executive comp.",
        },
        {
          title: "Multi-generational family land",
          body: "Trust-owned LLC, fair structure for non-ranching heirs.",
        },
        {
          title: "Lake Travis second-home owners",
          body: "Cross-county deeds, dual-residence titling.",
        },
        {
          title: "Blended situations",
          body: "All of the above, in one coordinated plan.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "Available to Spicewood residents",
      title: "What we build for Spicewood families.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Complex multi-property, multi-county plans.",
        },
        {
          icon: "vault",
          title: "Living Trusts",
          body: "Foundation document that holds property in any county.",
        },
        {
          icon: "lock",
          title: "Irrevocable Trusts",
          body: "ILITs, SLATs, and asset-protection structures.",
        },
        {
          icon: "shield",
          title: "Asset Protection",
          body: "Layered defense for high-income professionals.",
        },
        {
          icon: "briefcase",
          title: "Business Trusts",
          body: "For tech executives and consulting professionals.",
        },
        {
          icon: "succession",
          title: "Business Succession",
          body: "Exit planning for Spicewood business owners.",
        },
      ],
    },
    {
      kind: "faq",
      eyebrow: "Spicewood FAQ",
      title: "Questions from across the county lines.",
      items: [
        {
          q: "We have a Spicewood mailing address but our home is technically in Travis County. Does the trust care?",
          a: "The trust itself does not care which county the property is in — a Texas trust can hold real property anywhere in the state. What does care is the deed-filing process. We pull the existing deed, confirm the recording county, and file the new deed into the trust with that specific county clerk. For Spicewood clients, the deed often goes to the Travis County Clerk's office in Austin even though the mailing address says Spicewood.",
        },
        {
          q: "How do you handle a primary residence in Austin and a lake home in Spicewood?",
          a: "Both deeded into the same trust through two separate deed filings. The trust holds both properties simultaneously and the successor trustee can act on either one without re-titling anything. This is materially better than the common alternative — which is letting probate handle both, often in two different counties under two separate proceedings.",
        },
        {
          q: "Does Spicewood's mix of counties affect property taxes?",
          a: "Each county appraisal district assesses the property in its county independently. Burnet, Travis, and Blanco all have separate appraisal districts with slightly different practices. We confirm the appraisal-district status of each property during planning so that homestead exemptions, ag-valuations, and over-65 freezes carry through the trust transfer correctly in each jurisdiction.",
        },
        {
          q: "We have business interests in Austin — can the same plan cover them?",
          a: "Yes. Business interests are property — typically intangible personal property like LLC membership interests or corporate stock — and the trust can hold them alongside the real estate. For business owners, we usually pair the personal trust with one or more entity-level structures (operating LLCs, holding LLCs, sometimes series LLCs) to handle the liability separation, leaving the trust to handle the ownership and succession dimensions.",
        },
      ],
    },
  ],
