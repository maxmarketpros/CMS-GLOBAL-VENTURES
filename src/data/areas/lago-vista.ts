...
export const lagoVista: Area = {
  ...
  localHook:
    "Lago Vista property in Travis County paired with primary residences elsewhere makes proper trust funding essential — a will alone usually is not enough.",
  driveTime: "40 minutes from our Granite Shoals service area",
  population: "~8,900",
  landmarks: ["Lake Travis", "Lago Vista Golf Course"],
  heroPhoto: "/stock/7.jpg",
  bodyPhoto: "/stock/11.jpg",
  lat: 30.4513,
  lng: -97.9892,
  zip: "78645",
  nearby: ["lakeway", "bee-cave", "spicewood"],
  sections: [
    {
      kind: "intro",
      eyebrow: "Lago Vista, Texas",
      title: "The peninsula plan — built around the lake house.",
      body: [
    ...
    },
    {
      kind: "photo",
      image: "/stock/11.jpg",
      alt: "Lake Travis from the Lago Vista peninsula",
      caption:
        "Lago Vista — north-shore peninsula community on Lake Travis, transitioning from resort to residential.",
      aspect: "wide",
    },
    {
      kind: "deep",
      eyebrow: "Resort-to-residential transition",
      title: "What changes when a vacation home becomes home.",
      body: [
    ...
    },
    {
      ...
      lng: -97.9892,
      zoom: 13,
      address: "Lago Vista, Travis County, Texas 78645",
      caption:
        "Lago Vista sits about 40 minutes south of our Granite Shoals service area, on the north shore of Lake Travis. We meet Lago Vista clients at home, at the lake, or anywhere convenient along the corridor.",
    },
    {
      kind: "alternating",
      eyebrow: "Lake-house succession",
      title: "Who gets the house — and how it stays in the family.",
      body: [
      ...
      image: "/stock/22.jpg",
      imageAlt: "A family enjoying time together at the lake",
      imageSide: "right",
      bullets: [
        {
          title: "Outright to one child with equalization",
          body: "Simplest — works when one child clearly wants it and others can be made whole.",
        },
        {
          title: "Trust holds for all children jointly",
          body: "Usage agreement governs scheduling, costs, and decisions.",
        },
        {
          title: "LLC owned by trust, units to children",
          body: "Most formal — clear operating agreement, defined buyout mechanism.",
        },
        {
          title: "Trust to grandchildren, life estate to spouse",
          body: "Spouse uses for life, eventual transfer skips a generation.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "Services for Lago Vista clients",
      title: "What lake-community planning needs.",
      subtitle:
