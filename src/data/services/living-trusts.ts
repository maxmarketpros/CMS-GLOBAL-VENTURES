...
export const livingTrusts: Service = {
  slug: "living-trusts",
  name: "Living Trusts",
  ...
  benefits: [
    ...
    },
    {
      ...
      description:
        "If a stroke or accident leaves you unable to manage your affairs, your successor trustee takes over instantly.",
    },
  ],
  details: [
    "A living trust works only if your assets are actually inside it. We handle the funding step so the structure works the day we hand it over.",
    "You can amend or revoke a living trust at any time. It's flexible, private, and inexpensive to maintain.",
  ],
  sections: [
    {
      kind: "intro",
      eyebrow: "Why a living trust",
      title: "Stay in control. Skip probate. Stay private.",
      body: [
    ...
    },
    {
      ...
      title: "How a living trust compares to a will alone.",
      subtitle:
      ...
      columns: [
        {
          heading: "Will only",
          tagline: "The default for families without a plan",
          bullets: [
        ...
        {
          heading: "Will + Living trust",
          tagline: "What we build for most families",
          bullets: [
    ...
    {
      kind: "alternating",
      eyebrow: "How funding works",
      title: "The trust is only as good as what is inside it.",
      body: [
      ...
      image: "/stock/14.jpg",
      imageAlt: "House keys and wallet on a wooden table",
      imageSide: "left",
      bullets: [
        {
          title: "Real estate retitled by recorded deed",
          body: "We prepare and file the deed with the county clerk.",
        },
        {
          title: "Bank and brokerage accounts retitled",
          body: "Or designated as transfer-on-death where simpler.",
        },
        {
          title: "LLC and partnership interests assigned",
          body: "Through a written assignment that respects your operating agreement.",
        },
        {
          title: "Retirement and life insurance beneficiaries aligned",
          body: "Trust named primary or contingent depending on tax strategy.",
        },
      ],
    },
    {
      kind: "checklist",
      eyebrow: "Funding worksheet",
      title: "What we retitle when we fund your trust.",
      subtitle:
      ...
      items: [
        {
          title: "Primary residence and homestead",
          body: "Deeded into the trust while preserving the Texas homestead exemption.",
        },
        {
          title: "Lake home or second residence",
          body: "Deeded into the trust to avoid out-of-state probate down the line.",
        },
        {
          title: "Investment property and rentals",
          body: "Often into a trust-owned LLC for liability separation.",
        },
        {
          title: "Brokerage and investment accounts",
          body: "Retitled or designated transfer-on-death depending on broker.",
        },
        {
          title: "Bank accounts and CDs",
          body: "Retitled in person at the branch, usually a 20-minute visit.",
        },
        {
          title: "LLC membership interests",
          body: "Assigned to the trust by written document, filed with the LLC records.",
        },
        {
          title: "Vehicles, boats, and trailers",
          body: "Optional — sometimes simpler to leave out of the trust for daily use.",
        },
        {
          title: "Life insurance and retirement",
          body: "Beneficiary forms updated, never retitled directly.",
        },
      ],
    },
    {
      kind: "deep",
      eyebrow: "Probate in the Highland Lakes",
      title: "What you are actually avoiding.",
      body: [
    ...
    {
      kind: "faq",
      eyebrow: "About living trusts",
      title: "Questions families ask before they sign.",
      items: [
        {
          q: "Do I lose control of my assets once they are in the trust?",
          a: "No. While you are alive and competent, you are the trustee. You can buy, sell, refinance, move money, and use property exactly as you do now. The trust is a container — not a third party with veto power. You can also amend or revoke the trust at any time, which is what the revocable in revocable living trust means.",
        },
        {
          q: "Does putting my home in a trust affect my homestead exemption?",
          a: "Not when the trust is drafted correctly. A qualifying revocable trust preserves the Texas homestead exemption as long as the grantor (you) retains the present right of occupancy and the power to revoke. We use trust language that the Texas appraisal districts and homestead-exemption statutes accept without question.",
        },
        {
          q: "Will the trust affect my taxes while I am alive?",
          a: "No. A revocable living trust is what the IRS calls a grantor trust. For income-tax purposes, the trust is invisible — all income and deductions flow through to your personal 1040 exactly as before. There is no separate trust tax return required during your lifetime.",
        },
        {
          q: "What about my mortgage — does putting the house in the trust trigger a due-on-sale clause?",
          a: "Federal law (the Garn–St. Germain Act) specifically protects transfers of residential property into a revocable trust by the borrower. As long as you remain a beneficiary and continue to occupy the home, your lender cannot call the loan due. We have transferred hundreds of mortgaged homes into trusts in Burnet, Llano, and Travis counties without a single issue.",
        },
        {
          q: "Can a creditor or a divorcing spouse reach into the trust?",
