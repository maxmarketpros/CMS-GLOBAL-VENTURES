...
export const businessSuccession: Service = {
  ...
  benefits: [
    ...
    },
    {
      ...
      description:
        "Your interest in the business sits inside a trust, so transfer happens automatically — no probate, no public filing.",
    },
    {
      title: "Funded buy-sell agreements",
      description:
        "We coordinate with life-insurance and disability policies so the cash to buy out a departing owner is actually there.",
    },
  ],
  details: [
    "Succession planning works best when it is done five to ten years before you actually need it.",
    "We coordinate with your CPA, financial advisor, and existing partners so the plan respects the agreements you have already made.",
  ],
  sections: [
    {
      kind: "intro",
      eyebrow: "The exit you choose",
      title: "Plan the transition. Do not let it happen to you.",
      body: [
    ...
    },
    {
      ...
      title: "Why most family businesses do not last.",
      subtitle:
      ...
      items: [
        {
          value: "30%",
          label: "Survive to Gen 2",
          sublabel:
            "Roughly 70% of family businesses fail or are sold during the founder's transition out.",
        },
        {
          value: "12%",
          label: "Reach Gen 3",
          sublabel:
            "By the third generation, only about one in eight family businesses are still operating.",
        },
        {
          value: "3%",
          label: "Survive to Gen 4",
          sublabel:
            "Four-generation family businesses are rare enough to be unusual.",
        },
        {
          value: "47%",
          label: "Owners with no plan",
          sublabel:
            "Of family business owners over 65, nearly half have no formal succession plan in place.",
        },
      ],
    },
    {
      kind: "cardGrid",
      eyebrow: "The three exits",
      title: "Three paths out, each with its own structure.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Pass the business to a child or family member. Often staged over years through gifting strategies and graduated management responsibility. Requires the next-generation owner to actually want the business — which is the question most plans skip.",
        },
        {
          icon: "briefcase",
          title: "Partner or employee buyout",
          body: "A co-owner or key employee buys the founder out, usually over a multi-year note. Funded buy-sell agreements with life and disability insurance protect against involuntary triggers. Common in professional practices and partnerships.",
        },
        {
          icon: "vault",
          title: "Third-party sale",
          body: "Sell the business to an outside buyer — strategic acquirer, competitor, private equity, or industry consolidator. Maximum liquidity, but requires the business to be sale-ready (clean books, transferable customer relationships, documented operations).",
        },
      ],
    },
    {
      kind: "alternating",
      eyebrow: "The mechanics that make it work",
      title: "Buy-sell agreements with real funding behind them.",
      body: [
      ...
      image: "/stock/10.jpg",
      imageAlt: "A team meeting reviewing business documents",
      imageSide: "right",
      bullets: [
        {
          title: "Cross-purchase vs. entity redemption",
          body: "Who actually buys the departing owner's interest — the other owners or the business itself.",
        },
        {
          title: "Life-insurance funding",
          body: "Each owner insured for an amount equal to their interest, with the buyer (or the entity) as beneficiary.",
        },
        {
          title: "Disability buyout coverage",
          body: "Separate disability buyout policies fund a buyout if an owner becomes permanently disabled.",
        },
        {
          title: "Valuation method baked in",
          body: "Fixed price, formula valuation, or independent appraiser — agreed in advance, updated annually.",
        },
      ],
    },
    {
      ...
      title: "How the IRS treats each path differently.",
      body: [
    ...
    {
      kind: "comparison",
      eyebrow: "Timing scenarios",
      title: "How early matters — and how to think about your window.",
      subtitle:
      ...
      columns: [
        {
          heading: "15+ years out",
          tagline: "Best-case planning window",
          bullets: [
        ...
        {
          heading: "5–10 years out",
          tagline: "Strong planning position",
          bullets: [
        ...
        {
          heading: "1–3 years out",
          tagline: "Workable but compressed",
          bullets: [
