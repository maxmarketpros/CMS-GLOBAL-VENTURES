...
export const healthcareDirectives: Service = {
  ...
  benefits: [
    ...
    },
    {
      ...
      description:
        "Names the one person who speaks for you on medical decisions when you cannot.",
    },
    {
  ...
  sections: [
    {
      kind: "intro",
      eyebrow: "If you cannot speak for yourself",
      title: "Three documents your family will be glad you signed.",
      body: [
    ...
    {
      kind: "cardGrid",
      eyebrow: "The three documents",
      title: "What each one says and what each one does.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "The Texas living will. States your wishes about artificial respiration, feeding tubes, dialysis, resuscitation, and other life-sustaining treatments if you are diagnosed with a terminal or irreversible condition. Speaks directly to physicians without requiring an agent to interpret.",
        },
        {
          icon: "heart",
          title: "Medical Power of Attorney",
          body: "Names the one person who makes medical decisions you have not specifically addressed in the directive. Authority to consent to treatment, refuse treatment, choose facilities, access records, and make end-of-life decisions when the directive does not apply.",
        },
        {
          icon: "users",
          title: "HIPAA Authorization",
          body: "Federal patient-privacy law (HIPAA) prevents medical providers from sharing your records without your written permission. This authorization names the family members and agents who are allowed to receive your medical information directly from your providers.",
        },
      ],
    },
    {
      kind: "alternating",
      eyebrow: "Before the documents matter",
      title: "The conversation to have with your family.",
      body: [
      ...
      image: "/stock/21.jpg",
      imageAlt: "Family members in a quiet conversation",
      imageSide: "left",
      bullets: [
        {
          title: "Where the documents live",
          body: "Binder location, digital copy access, who has copies.",
        },
        {
          title: "Your view on life support",
          body: "What you do and do not want — and the conditions in which you want it.",
        },
        {
          title: "Faith and personal values",
          body: "Religious or philosophical convictions that should guide decisions.",
        },
        {
          title: "Comfort vs. duration",
          body: "How you would want the trade-off weighed if it has to be.",
        },
      ],
    },
    {
      kind: "checklist",
      eyebrow: "Scenarios your directive should address",
      title: "Specific situations to cover before they happen.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Whether and when you would want resuscitation attempted.",
        },
        {
          title: "Mechanical ventilation",
          body: "Short-term while you heal — yes or no? Long-term with no recovery expected?",
        },
        {
          title: "Artificial nutrition and hydration",
          body: "Feeding tube and IV fluids in extended unconsciousness.",
        },
        {
          title: "Dialysis",
          body: "If your kidneys fail and recovery is unlikely.",
        },
        {
          title: "Surgery in extreme cases",
          body: "Major surgery when prognosis is poor.",
        },
        {
          title: "Blood transfusions",
          body: "Particularly relevant for clients with religious objections.",
        },
        {
          title: "Comfort-only care",
          body: "When you would want care shifted entirely to comfort and pain management.",
        },
        {
          title: "Organ and tissue donation",
          body: "What you authorize and which organs.",
        },
      ],
    },
    {
      kind: "deep",
      eyebrow: "The Texas advantage",
      title: "Statutory forms every hospital recognizes.",
      body: [
