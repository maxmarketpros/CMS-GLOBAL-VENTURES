...
export const irrevocableTrusts: Service = {
  ...
  benefits: [
    {
      ...
      description:
        "Assets inside an irrevocable trust are legally beyond the reach of future creditors, judgments, and long-term-care costs.",
    },
    {
      title: "Estate-tax efficiency",
      description:
        "Removes assets from your taxable estate, which matters for high-net-worth Hill Country lake homeowners.",
    },
    {
      title: "Medicaid and long-term-care planning",
      description:
        "Properly structured, an irrevocable trust can preserve family wealth while qualifying for Medicaid after the five-year look-back.",
    },
  ],
  details: [
    "Irrevocable trust planning is not for everyone. We walk you through the trade-offs before we recommend one.",
    "Common variants we build include ILITs, SLATs, Medicaid-asset-protection trusts, and special-needs trusts.",
  ],
  sections: [
    {
      kind: "intro",
      eyebrow: "What you are choosing",
      title: "Maximum protection. Maximum commitment.",
      body: [
    ...
    {
      kind: "deep",
      eyebrow: "The honest trade-offs",
      title: "What you give up to get the protection.",
      body: [
    ...
    {
      kind: "cardGrid",
      eyebrow: "Five trusts we build often",
      title: "Variants we recommend based on the goal.",
      subtitle:
      ...
      items: [
        {
          icon: "shield",
          title: "ILIT — Irrevocable Life Insurance Trust",
          body: "Owns a life-insurance policy so the death benefit passes to heirs free of estate tax. Particularly useful for families approaching the federal exemption.",
        },
        {
          icon: "vault",
          title: "SLAT — Spousal Lifetime Access Trust",
          body: "One spouse funds an irrevocable trust for the benefit of the other (and children). Removes assets from the estate while preserving indirect access for the funding spouse's lifetime.",
        },
        {
          icon: "heart",
          title: "Medicaid Asset Protection Trust",
          body: "Used five or more years before anticipated need for long-term care. Allows Medicaid qualification while preserving the family home and savings.",
        },
        {
          icon: "users",
          title: "Special-Needs Trust",
          body: "Holds assets for a beneficiary with a disability without disqualifying them from SSI, Medicaid, or other means-tested benefits.",
        },
        {
          icon: "scroll",
          title: "QPRT — Qualified Personal Residence Trust",
          body: "Transfers a primary or vacation home out of your estate at a discounted gift-tax value, while you continue living in it for a fixed term.",
        },
        {
          icon: "lock",
          title: "Domestic Asset Protection Trust",
          body: "A self-settled trust formed in a protective jurisdiction. Used by professionals in high-liability fields who need a creditor shield around personal wealth.",
        },
      ],
    },
    {
      kind: "comparison",
      eyebrow: "Choosing a structure",
      title: "Revocable or irrevocable — and when to combine them.",
      subtitle:
      ...
      columns: [
        {
          heading: "Revocable living trust",
          tagline: "Your operating layer",
          bullets: [
    ...
    },
    {
      ...
      title: "The situations where this tool is the right one.",
      body: [
      ...
      image: "/stock/19.jpg",
      imageAlt: "A modern interior with secure storage",
      imageSide: "right",
      bullets: [
        {
          title: "Business owners pre-sale",
          body: "Move appreciation out of the estate before the liquidity event.",
        },
        {
          title: "High-liability professionals",
          body: "Doctors, surgeons, financial advisors, real-estate developers.",
        },
        {
          title: "Long-term-care planning families",
          body: "Five-plus years out from anticipated nursing care.",
        },
        {
          title: "Special-needs households",
          body: "Preserving SSI and Medicaid for a beneficiary with disabilities.",
        },
      ],
    },
    {
      ...
      title: "Questions clients ask before going irrevocable.",
      items: [
        {
          q: "What happens if my circumstances change — divorce, family dispute, market crash?",
