  ...
  benefits: [
    {
      ...
      description:
        "A signed POA replaces the need for a guardianship hearing if you are ever incapacitated.",
    },
    {
      title: "Two types, both important",
      description:
        "We draft a Texas Statutory Durable Power of Attorney for finances and a Medical Power of Attorney for healthcare decisions.",
    },
    {
      title: "Springing or immediate",
      description:
        "You choose whether your POA is active the moment you sign it, or only kicks in after a doctor certifies you are incapacitated.",
    },
  ],
  details: [
    "Texas law has specific requirements for a durable power of attorney to be valid.",
    "We pair every POA with a HIPAA authorization so your named agent can actually talk to your doctors.",
  ],
  sections: [
    {
      kind: "intro",
      eyebrow: "If you cannot, someone must",
      title: "Naming the person who acts when you cannot.",
      body: [
    ...
    {
      kind: "cardGrid",
      eyebrow: "The three powers we draft",
      title: "Different authority for different parts of your life.",
      subtitle:
      ...
      items: [
        {
          icon: "vault",
          title: "Statutory Durable Financial POA",
          body: "Texas Estates Code §752. Authorizes your agent to handle every category of financial decision — banking, real estate, taxes, retirement, business operations. The default broad financial authority document.",
        },
        {
          icon: "heart",
          title: "Medical Power of Attorney",
          body: "Texas Health & Safety Code §166. Names the one person who can make medical decisions for you when you cannot, including consent to and refusal of treatment. Always paired with HIPAA authorization.",
        },
        {
          icon: "signature",
          title: "Limited or special POA",
          body: "Narrow authority for a single transaction — selling a specific property, signing closing documents while traveling, managing a single account. Used alongside the broad documents, not as a substitute.",
        },
      ],
    },
    {
      kind: "comparison",
      eyebrow: "When the POA activates",
      title: "Springing vs. immediate effect.",
      subtitle:
      ...
      columns: [
        {
          heading: "Immediate effective POA",
          tagline: "Authority starts on signing",
          bullets: [
        ...
        {
          heading: "Springing POA",
          tagline: "Authority starts on incapacity",
          bullets: [
    ...
    {
      kind: "checklist",
      eyebrow: "Powers you can grant",
      title: "Specific authority you choose to enable.",
      subtitle:
      ...
      items: [
        {
          ...
          body: "Buy, sell, mortgage, lease, manage real estate on your behalf.",
        },
        {
          title: "Tangible personal property",
          body: "Vehicles, equipment, furnishings, valuables.",
        },
        {
          title: "Banking and financial institutions",
          body: "Access accounts, write checks, transfer funds, manage CDs and brokerage accounts.",
        },
        {
          title: "Business operations",
          body: "Run an LLC, sign on behalf of a partnership, manage business accounts.",
        },
        {
          title: "Insurance and annuities",
          body: "Manage policies, change beneficiaries, file claims, surrender annuities.",
        },
        {
          title: "Estate and trust transactions",
          body: "Receive distributions, manage trust property, deal with executors.",
        },
        {
          title: "Tax matters",
          body: "Sign returns, communicate with IRS, contest assessments. Requires a separate IRS Form 2848 for federal tax matters.",
        },
        {
          title: "Retirement plan transactions",
          body: "Roll over IRAs, take distributions, change investment elections, name beneficiaries.",
        },
      ],
    },
    {
      kind: "deep",
      eyebrow: "The Texas statutory form",
      title: "Why we use the statutory document, not a generic POA.",
      body: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "Do I lose any rights by signing a POA?",
          a: "No. Signing a POA does not strip you of any authority — you can still act for yourself at any time. The POA adds your agent's authority alongside yours; it does not subtract from yours. You can also revoke the POA in writing at any time as long as you have capacity to do so.",
        },
        {
          q: "What if I do not name a POA and become incapacitated?",
